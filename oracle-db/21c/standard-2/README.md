# 21c / Standard Edition 2 (SE2)

Installation tooling for Standard Edition 2 of Oracle Database 21c.
...
All wrappers pre-seed `ORACLE_VERSION=21c` and `ORACLE_EDITION=SE2`
