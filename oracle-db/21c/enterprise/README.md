# 21c / Enterprise Edition (EE)

Installation tooling for Enterprise Edition of Oracle Database 21c.
...
All wrappers pre-seed `ORACLE_VERSION=21c` and `ORACLE_EDITION=EE`
