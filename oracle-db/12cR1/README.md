# 12cR1/  (Oracle Database 12c Release 1)

Per-edition installation tooling for Oracle Database 12c Release 1.
...
| Standard Edition | `standard/` | SE | deprecated |
| Standard Edition One | `standard-one/` | SE1 | deprecated |
