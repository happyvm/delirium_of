# 12cR1 / Enterprise Edition (EE)

Installation tooling for Enterprise Edition of Oracle Database 12c Release 1.
...
All wrappers pre-seed `ORACLE_VERSION=12cR1` and `ORACLE_EDITION=EE`
