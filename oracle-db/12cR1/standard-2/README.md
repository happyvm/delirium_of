# 12cR1 / Standard Edition 2 (SE2)

Installation tooling for Standard Edition 2 of Oracle Database 12c Release 1.
...
All wrappers pre-seed `ORACLE_VERSION=12cR1` and `ORACLE_EDITION=SE2`
