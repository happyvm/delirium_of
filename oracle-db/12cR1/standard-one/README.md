# 12cR1 / Standard Edition One (SE1)

Installation tooling for Standard Edition One of Oracle Database 12c Release 1.
...
All wrappers pre-seed `ORACLE_VERSION=12cR1` and `ORACLE_EDITION=SE1`
