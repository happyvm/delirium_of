# 18c / Standard Edition 2 (SE2)

Installation tooling for Standard Edition 2 of Oracle Database 18c.
...
All wrappers pre-seed `ORACLE_VERSION=18c` and `ORACLE_EDITION=SE2`
