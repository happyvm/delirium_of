# 19c / Standard Edition 2 (SE2)

Installation tooling for Standard Edition 2 of Oracle Database 19c.
...
All wrappers pre-seed `ORACLE_VERSION=19c` and `ORACLE_EDITION=SE2`
