# 19c / Enterprise Edition (EE)

Installation tooling for Enterprise Edition of Oracle Database 19c.
...
All wrappers pre-seed `ORACLE_VERSION=19c` and `ORACLE_EDITION=EE`
