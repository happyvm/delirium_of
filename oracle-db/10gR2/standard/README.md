# 10gR2 / Standard Edition (SE)

Installation tooling for Standard Edition of Oracle Database 10g Release 2.
...
All wrappers pre-seed `ORACLE_VERSION=10gR2` and `ORACLE_EDITION=SE`
