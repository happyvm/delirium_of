# 11gR1 / Standard Edition (SE)

Installation tooling for Standard Edition of Oracle Database 11g Release 1.
...
All wrappers pre-seed `ORACLE_VERSION=11gR1` and `ORACLE_EDITION=SE`
