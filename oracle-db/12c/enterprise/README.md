# 12c / Enterprise Edition (EE)

Installation tooling for Enterprise Edition of Oracle Database 12c.
...
All wrappers pre-seed `ORACLE_VERSION=12c` and `ORACLE_EDITION=EE`
