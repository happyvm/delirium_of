# 26ai / Standard Edition 2 (SE2)

Installation tooling for Standard Edition 2 of Oracle AI Database 26ai.
...
All wrappers pre-seed `ORACLE_VERSION=26ai` and `ORACLE_EDITION=SE2`
