# 26ai / Enterprise Edition (EE)

Installation tooling for Enterprise Edition of Oracle AI Database 26ai.
...
All wrappers pre-seed `ORACLE_VERSION=26ai` and `ORACLE_EDITION=EE`
