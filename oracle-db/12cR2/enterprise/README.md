# 12cR2 / Enterprise Edition (EE)

Installation tooling for Enterprise Edition of Oracle Database 12c Release 2.
...
All wrappers pre-seed `ORACLE_VERSION=12cR2` and `ORACLE_EDITION=EE`
