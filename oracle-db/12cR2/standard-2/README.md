# 12cR2 / Standard Edition 2 (SE2)

Installation tooling for Standard Edition 2 of Oracle Database 12c Release 2.
...
All wrappers pre-seed `ORACLE_VERSION=12cR2` and `ORACLE_EDITION=SE2`
