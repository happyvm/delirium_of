# 11gR2 / Enterprise Edition (EE)

Installation tooling for Enterprise Edition of Oracle Database 11g Release 2.
...
All wrappers pre-seed `ORACLE_VERSION=11gR2` and `ORACLE_EDITION=EE`
