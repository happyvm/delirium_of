# 11gR2 / Standard Edition One (SE1)

Installation tooling for Standard Edition One of Oracle Database 11g Release 2.
...
All wrappers pre-seed `ORACLE_VERSION=11gR2` and `ORACLE_EDITION=SE1`
